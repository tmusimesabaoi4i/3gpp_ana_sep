...
def build_unique_by_iprd_id(tbl, *, out_table: str, return_heads: list[str] | None = None):
...
def run_company_fd(raw_norm, *, scope: str, al: TableAL) -> None:
    ...
    dim = "cmp"
    heads_needed = ["IPRD_ID", "COMP_LEGAL_NAME"]
    ...
    for gen_col in GEN_COLS:
        ...
        t_unique = build_unique_by_iprd_id(
            t_filtered,
...
def run_tstrnum_fd(raw_norm, *, scope: str, al: TableAL) -> None:
    ...
    """
    dim = "tno"
    heads_for_concat = ["IPRD_ID", "3GPP_Type", "TGPP_NUMBER"]
...
def run_company_fd_for_selected_tstr(raw_norm, *, scope: str, al: TableAL) -> None:
    ...
    heads_needed = ["IPRD_ID", "COMP_LEGAL_NAME", "3GPP_Type", "TGPP_NUMBER"]
    ...
    for gen_col in GEN_COLS:
        ...
        t_with_tstr = build_tstrnum_table(
            ...
            return_heads=["IPRD_ID", "COMP_LEGAL_NAME", TSTR_COL],
        )
